# CLAUDE.md — Magicpin AI Challenge: Vera Message Engine
...
3. **Call Claude API** with a system prompt that enforces:
...
**Important**: Do NOT call Claude API in a loop one-by-one. Batch your compose calls or run them concurrently with threading to stay within the 30s timeout.
